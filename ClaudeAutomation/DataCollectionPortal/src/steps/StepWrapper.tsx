...
import type { SummaryItem } from "../components/SectionSummary";
...
interface Props {
  ...
  nextLabel?: string;
  isLastStep?: boolean;
  /** When provided, clicking "Save & Continue" shows this summary before advancing. */
...
export function StepWrapper({
  ...
  const hasSummary = summaryItems !== undefined && nextSectionLabel !== undefined;
  ...
  // When summary is confirmed, advance navigation and reset summary state
  ...
  return (
    <div className="pb-8">
      ...
      {/* Summary interstitial — shown after "Save & Continue" when summaryItems provided */}
      {showSummary && hasSummary ? (
        <div className="mb-8">
          <SectionSummary
            ...
            onConfigure={handleSummaryConfirm}
      ...
      {/* Nav buttons — hidden while showing summary (summary has its own Edit / Configure buttons) */}
      {!showSummary && (
        <>
