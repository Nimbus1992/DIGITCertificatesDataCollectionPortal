...
const scopeOptions: { value: AvailabilityScope; label: string; description: string; icon: typeof MapPin }[] = [
  { value: "entire_state", label: "Entire State", description: "Your service will be available across the entire state", icon: Map },
  { value: "cities", label: "Selected Cities", description: "Choose specific cities where this service will be available", icon: Building2 },
  { value: "districts", label: "Selected Districts", description: "Choose specific districts for this service", icon: MapPin },
      ...
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        <div className="max-w-lg w-full mx-auto animate-slide-up">
          ...
          <HelperText
            ...
            reassurance="This can be expanded anytime from your service settings."
          />
